	...
	const renderRecipes = (recipeType) => (
		<div className='d-flex flex-nowrap overflow-auto'>
			{recipes[recipeType].map((recipe) => (
				<div key={recipe.id} className='col-md-3 mb-4 me-4 card h-100'>
					<div className='card'>
	...
	return (
		<div>
			...
			<footer className='bg-dark text-light mt-5 py-4 '>
				<div className='container text-center py-4 me-5'>
					<div className='row '>
						<div className='col-md-4 mb-3'>
							<h5 className='mx-60 '>About Foodio</h5>
							<p>
						...
						<div className='col-md-4 mb-3 text-end pe-5 '>
							<h5>Connect With Us</h5>
							<div className='d-flex gap-3 justify-content-end'>
								<a
									href='/facebook'
									className='text-light text-decoration-none hover-effect_1 text-end '
								>
									<i className='bi bi-facebook fs-4 '></i>
								</a>
								<a
									href='/instagram '
									className='text-light text-decoration-none hover-effect_2 text-end '
								>
									<i className='bi bi-instagram fs-4'></i>
								</a>
								<a
									href='/twitter'
									className='text-light text-decoration-none hover-effect_3'
								>
									<i className='bi bi-twitter fs-4'></i>
								</a>
								<a
									href='/interest'
									className='text-light text-decoration-none hover-effect_4'
								>
