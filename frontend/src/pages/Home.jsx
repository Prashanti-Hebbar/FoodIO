        ...
        <div>
            <div id="recipeCarousel" className="carousel slide" data-bs-ride="carousel">
                <div className="carousel-inner">
                    ...
                    <div className="carousel-item">
                        <img src="../carousel3.jpg" className="d-block w-100" alt="Recipe 3" style={{objectFit:"cover", height:"550px"}}/>
                        <div className="carousel-caption d-none d-md-block">
                            <h5>Quick & Easy</h5>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-4 mb-3">
                            <h5>About Foodio</h5>
                            <p>
                                A collaborative recipe sharing platform designed to make cooking
                                a social experience. Join our community of culinary enthusiasts!
                            </p>
                        </div>
                        <div className="col-md-4 mb-3">
                            <h5>Quick Links</h5>
                            <ul className="list-unstyled">
                                <li>
                                    <Link to="/top-rated" className="text-white text-decoration-none hover-effect">
                                        Top Rated
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/trending" className="text-light text-decoration-none hover-effect">
                                        Trending
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/submit" className="text-light text-decoration-none hover-effect">
                                        Submit Recipe
                                    </Link>
                                </li>
                                <li>
                                    <Link to="/community" className="text-light text-decoration-none hover-effect">
                                        Community
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className="col-md-4 mb-3">
                            ...
                            <div className="d-flex gap-3">
                                <a href="/facebook" className="text-light text-decoration-none hover-effect_1">
                                    <i className="bi bi-facebook fs-4"></i>
                                </a>
                                <a href="/instagram" className="text-light text-decoration-none hover-effect_2">
                                    <i className="bi bi-instagram fs-4"></i>
                                </a>
                                <a href="/twitter" className="text-light text-decoration-none hover-effect_3">
                                    <i className="bi bi-twitter fs-4"></i>
                                </a>
                                <a href="/interest" className="text-light text-decoration-none hover-effect_4">
